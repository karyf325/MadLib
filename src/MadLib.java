...
public class MadLib
{
	...
	public static void main(String[] args)
	{
		...
		System.out.print("\nPlease enter a proper he or she:   "); 
		...
		System.out.print("\nPlease enter a play/musical:   ");
		
		String playmusical = keyboard.nextLine();
		System.out.print("\nPlease enter a verb:    ");
		String verb2 = keyboard.nextLine();
		System.out.print("\nPlease enter a clothing item:    ");
		
		String clothingitem = keyboard.nextLine();
	
		
		System.out.print("I was " + verb + " in the car when " + heshe + " "+
		verb1 + " at me " + "I was so " + emotion + " to see that it was " + propernoun1
